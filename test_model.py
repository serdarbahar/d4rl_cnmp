...
import numpy as np
import torch
from cnmp import CNMP, CNMP_H, CNMP_T, generate_trajectory # Assuming these are your custom modules
from scipy.interpolate import interp1d
from scipy.spatial import ConvexHull

# --- Model and Data Loading (Unchanged) ---
model = CNMP_H(d_x=1, d_y=30, d_SM=30).double()
model.load_state_dict(torch.load("save/best_model_newdataset_diff.pth"))
model.eval()

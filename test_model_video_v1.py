...
for i in range(num_tests):
    ...
    for j in range(2):
        ...
        plt.xlabel(dim_labels[j]['xlabel'], fontsize=12)
        plt.ylabel(dim_labels[j]['ylabel'], fontsize=12)
    ...
    plt.tight_layout()
    plt.savefig(f"video_test_{seed+i}.png")
